!(function (t) {
    ...
    function (t, e, i) {
        ...
        function r(t, e) {
            for (var i = {}, s = [], n = 0; n < t.length; n++) {
                ...
                -1 !== c ? (h[c].references++, h[c].updater(d)) : h.push({ identifier: g, updater: f(d, e), references: 1 }), s.push(g);
            }
            return s;
        }
        function l(t) {
        ...
        function d(t, e, i, s) {
            ...
            if (t.styleSheet) t.styleSheet.cssText = c(e, n);
                ...
                var o = document.createTextNode(n),
                    h = t.childNodes;
                h[e] && t.removeChild(h[e]), h.length ? t.insertBefore(o, h[e]) : t.appendChild(o);
            }
        }
        function p(t, e, i) {
            var s = i.css,
        ...
        function f(t, e) {
            ...
            if (e.singleton) {
                var o = m++;
                (i = u || (u = l(e))), (s = d.bind(null, i, o, !1)), (n = d.bind(null, i, o, !0));
            } else
                (i = l(e)),
                    (s = p.bind(null, i, e)),
                    (n = function () {
                ...
                (e.toString = function () {
                    return this.map(function (e) {
                        var i = (function (t, e) {
                            ...
                            if (e && "function" == typeof btoa) {
                                var n = ((h = s), (a = btoa(unescape(encodeURIComponent(JSON.stringify(h))))), (r = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a)), "/*# ".concat(r, " */")),
                    ...
                    (e.i = function (t, i, s) {
                        ...
                        for (var a = 0; a < t.length; a++) {
                            var r = [].concat(t[a]);
                            (s && n[r[0]]) || (i && (r[2] ? (r[2] = "".concat(i, " and ").concat(r[2])) : (r[2] = i)), e.push(r));
                        }
                    }),
                    e
            );
    ...
    function (t, e, i) {
        ...
        class n extends s {
            constructor(t, e) {
                super(t), (this.image = null), (this.isLoad = !1), (this.loadingAngle = 0), (this.image = new Image()), (this.image.src = e);
            }
            draw() {
                ...
                for (let i of this.state.area) null !== i && ((i = this.render.convertToGlobal(i)), t.lineTo(i.x - e.x, i.y - e.y));
                if ((t.rotate(this.state.angle), t.clip(), this.isLoad)) t.drawImage(this.image, 0, 0, i, s);
                else {
                    t.beginPath(), (t.strokeStyle = "rgb(200, 200, 200)"), (t.fillStyle = "rgb(255, 255, 255)"), (t.lineWidth = 1), t.rect(1, 1, i - 1, s - 1), t.stroke(), t.fill();
                    const e = { x: i / 2, y: s / 2 };
                    t.beginPath(),
                        (t.lineWidth = 10),
            ...
            simpleDraw(t) {
                ...
                if (this.isLoad) i.drawImage(this.image, o, h, s, n);
                    ...
                    i.beginPath(), (i.strokeStyle = "rgb(200, 200, 200)"), (i.fillStyle = "rgb(255, 255, 255)"), (i.lineWidth = 1), i.rect(o + 1, h + 1, s - 1, n - 1), i.stroke(), i.fill();
                    const t = { x: o + s / 2, y: h + n / 2 };
                    i.beginPath(),
                        (i.lineWidth = 10),
                        i.arc(t.x, t.y, 20, this.loadingAngle, (3 * Math.PI) / 2 + this.loadingAngle),
                        i.stroke(),
                        i.closePath(),
                        (this.loadingAngle += 0.07),
                    this.loadingAngle >= 2 * Math.PI && (this.loadingAngle = 0);
            ...
            show(t) {
                ...
                (this.app.updatePage(t),
                    "portrait" === this.render.getOrientation()
                        ...
                        : (t === this.pages.length - 1 && t--, this.render.setLeftPage(this.pages[t]), this.render.setRightPage(this.pages[t + 1])));
            }
        }
        class h extends o {
            constructor(t, e, i) {
        ...
        class a {
            ...
            static GetAngleFromTwoLine(t, e) {
                const i = t[0].y - t[1].y,
                    ...
                    n = t[1].x - t[0].x,
                    o = e[1].x - e[0].x;
                return Math.acos((i * s + n * o) / (Math.sqrt(i * i + n * n) * Math.sqrt(s * s + o * o)));
            }
            ...
            static GetIntersectByLineAndCircle(t, e, i) {
                ...
                const s = t.x,
                    ...
                    o = i.x,
                    h = i.y;
                let r = Math.sqrt((Math.pow(e, 2) * Math.pow(s - o, 2)) / (Math.pow(s - o, 2) + Math.pow(n - h, 2))) + s;
                i.x < 0 && (r *= -1);
                let l = ((r - s) * (n - h)) / (s - o) + n;
            ...
            static GetCordsFromTwoPoint(t, e) {
                ...
                for (let a = 1; a <= n; a++) o.push({ x: h(t.x, e.x, i, n, a), y: h(t.y, e.y, s, n, a) });
                return o;
            }
        }
        class r extends s {
            ...
            draw() {
                ...
                for (const t of this.state.area)
                    if (null !== t) {
                        ...
                        (e = a.GetRotatedPoint(e, { x: 0, y: 0 }, this.state.angle)), (s += e.x + "px " + e.y + "px, ");
                    }
                (s = s.slice(0, -2)),
                    (s += ")"),
                    (this.element.style.clipPath = s),
                    this.element.style.setProperty("-webkit-clip-path", s),
                    (this.element.style.transform = "translate3d(" + t.x + "px, " + t.y + "px, 0) rotate(" + this.state.angle + "rad)");
            }
            simpleDraw(t) {
        ...
        class g {
            constructor(t, e, i, s) {
                (this.direction = t), (this.corner = e), (this.pageWidth = i), (this.pageHeight = s), (this.topIntersectPoint = null), (this.sideIntersectPoint = null), (this.bottomIntersectPoint = null);
            }
            calc(t) {
                try {
                    (this.position = this.preparePosition(t)), this.calculateIntersectPoint(this.position);
                } catch (t) {}
            }
            getPageRect(t) {
            ...
            checkPositionAtCenterLine(t, e, i) {
                ...
                let h = this.rect.bottomRight,
                    r = this.rect.topLeft;
                if (("bottom" === this.corner && ((h = this.rect.topRight), (r = this.rect.bottomLeft)), h.x <= 0)) {
                ...
                return (
                    t.push(this.topIntersectPoint),
                        ...
                        null !== this.sideIntersectPoint
                            ? a.GetDestinationFromTwoPoint(this.sideIntersectPoint, this.topIntersectPoint) >= 10 && t.push(this.sideIntersectPoint)
        ...
        class c {
                ...
                try {
                    return (
                        (this.flippingPage = this.getFlippingPage(s)),
                            ...
                            this.flippingPage && this.bottomPage ? (this.render.setDirection(s), (this.calc = new g(s, n, i.pageWidth, i.height)), !0) : !1
                    );
                } catch (t) {
                    return !1;
                }
            ...
            animateFlippingTo(t, e, i, s = !0) {
                ...
                this.render.startAnimation(o, h, () => {
                    ...
                    s && (this.render.setBottomPage(null), this.render.setFlippingPage(null), this.render.clearShadow(), (this.state = "read"), this.reset()));
                });
            }
                ...
                return (
                    "stretch" === this.setting.size
                        ? (e < 2 * this.setting.minWidth && this.app.getSettings().usePortrait && (t = "portrait"),
                            (o = "landscape" === t ? this.getBlockWidth() / 2 : this.getBlockWidth()),
                        ...
                        : e < 2 * o && this.app.getSettings().usePortrait && ((t = "portrait"), (a = i - o / 2 - o)),
                        (this.boundsRect = {
                            left: a,
                            top: s - h / 2,
                            width: 2 * o,
        ...
        class u {
            constructor(t, e, i) {
                (this.touchPoint = null), (this.swipeTimeout = 250), (this.swipeDistance = 80), (this.wrapper = t), this.wrapper.classList.add("stf__wrapper"), (this.app = e);
                ...
                "fixed" === i.size && ((this.wrapper.style.minWidth = i.width * s + "px"), (this.wrapper.style.minHeight = i.height * s + "px")),
                i.autoSize && ((this.wrapper.style.width = "100%"), (this.wrapper.style.maxWidth = 2 * i.maxWidth + "px")),
        ...
        class m extends u {
            constructor(t, e, i, s) {
                super(t, e, i), t.insertAdjacentHTML("afterbegin", '<div class="stf__block"></div>'), (this.distElement = t.querySelector(".stf__block"));
        ...
        class y extends d {
            constructor(t, e, i, s) {
                super(t, e), (this.outerShadow = null), (this.innerShadow = null), (this.element = i), (this.items = s);
            }
            getBlockWidth() {
            ...
            clearShadow() {
                super.clearShadow(), this.outerShadow.remove(), this.innerShadow.remove(), (this.outerShadow = null), (this.innerShadow = null);
            }
            drawShadow(t, e, i, s, n) {
            ...
            drawInnerShadow() {
                ...
                (this.innerShadow.style.width = e + "px"),
                    ...
                    (this.innerShadow.style.transform = "translate3d(" + (n.x - i) + "px, " + (n.y - 100) + "px, 0) rotate(" + o + "rad)");
                const h = [this.pageRect.topLeft, this.pageRect.topRight, this.pageRect.bottomRight, this.pageRect.bottomLeft];
                let r = "polygon( ";
                for (const t of h) {
                    ...
                    (e = a.GetRotatedPoint(e, { x: i, y: 100 }, o)), (r += e.x + "px " + e.y + "px, ");
                }
                (r = r.slice(0, -2)), (r += ")"), (this.innerShadow.style.clipPath = r), this.innerShadow.style.setProperty("-webkit-clip-path", r);
            }
            drawOuterShadow() {
                const t = this.getRect(),
                ...
                const o = [];
                o.push({ x: 0, y: 0 }, { x: t.pageWidth, y: 0 }, { x: t.pageWidth, y: t.height }, { x: 0, y: t.height });
                let h = "polygon( ";
                for (const t of o)
                    if (null !== t) {
                        let e = 1 === this.getDirection() ? { x: -t.x + this.shadow.pos.x, y: t.y - this.shadow.pos.y } : { x: t.x - this.shadow.pos.x, y: t.y - this.shadow.pos.y };
                        (e = a.GetRotatedPoint(e, { x: s, y: 100 }, i)), (h += e.x + "px " + e.y + "px, ");
                    }
                (h = h.slice(0, -2)), (h += ")"), (this.outerShadow.style.clipPath = h), this.outerShadow.style.setProperty("-webkit-clip-path", h);
            }
            drawFrame(t) {
                this.clear(),
                    "portrait" !== this.orientation ? null != this.leftPage && this.leftPage.simpleDraw(0) : null != this.leftPage && this.leftPage.clearSaved(),
                null != this.rightPage && this.rightPage.simpleDraw(1),
                null != this.bottomPage && (("portrait" === this.orientation && 1 === this.direction) || ((this.bottomPage.getElement().style.zIndex = (this.getSettings().startZIndex + 3).toString(10)), this.bottomPage.draw())),
                null != this.flippingPage && ((this.flippingPage.getElement().style.zIndex = (this.getSettings().startZIndex + 4).toString(10)), this.flippingPage.draw()),
                null != this.shadow && (this.drawOuterShadow(), this.drawInnerShadow());
            }
            clear() {
                const t = [];
            ...
            setRightPage(t) {
                this.clearClass(this.rightPage), null !== this.rightPage && t !== this.rightPage && this.rightPage.clearSaved(), null !== t && t.getElement().classList.add("--right"), super.setRightPage(t);
            }
            setLeftPage(t) {
                this.clearClass(this.leftPage), null !== this.leftPage && t !== this.rightPage && this.leftPage.clearSaved(), null !== t && t.getElement().classList.add("--left"), super.setLeftPage(t);
            }
            setBottomPage(t) {
                null !== t && t.getElement().classList.add(1 === this.direction ? "--left" : "--right"), super.setBottomPage(t);
            }
            setFlippingPage(t) {
                null !== t && t.getElement().classList.add(1 === this.direction ? "--right" : "--left"), super.setFlippingPage(t);
            }
            update() {
                super.update(),
                null !== this.rightPage && (this.rightPage.getElement().classList.add("--right"), this.rightPage.clearSaved()),
                null !== this.leftPage && (this.leftPage.getElement().classList.add("--left"), this.leftPage.clearSaved());
            }
        }
        let x = (() => {
            class t {
        ...
        class w extends class {
            ...
            constructor(t, e) {
                super(), (this.isUserTouch = !1), (this.isUserMove = !1), (this.pages = null), (this.currentPage = 0), (this.setting = null);
                try {
            ...
            turnToPrevPage() {
                ...
                this.currentPage < t || ((this.currentPage -= t), this.pages.show(this.currentPage));
            }
            turnToNextPage() {
                const t = "portrait" === this.render.getOrientation() ? 1 : 2;
                this.currentPage > this.pages.getPageCount() - t || ((this.currentPage += t), this.pages.show(this.currentPage));
            }
            turnToPage(t) {
                this.checkPage(t) && ((this.currentPage = t), this.pages.show(this.currentPage));
            }
            flipNext(t = "top") {
            ...
            updateOrientation(t) {
                "landscape" === t ? (this.currentPage % 2 != 0 && this.currentPage--, this.update()) : (this.currentPage++, this.update()), this.ui.setOrientationStyle(t), this.trigger("changeOrientation", this, t);
            }
            getPageCount() {
            ...
            userMove(t, e) {
                this.isUserTouch || e ? this.isUserTouch && a.GetDestinationFromTwoPoint(this.mousePosition, t) > 5 && ((this.isUserMove = !0), this.flip.fold(t)) : this.flip.showCorner(t);
            }
            userStop(t, e = !1) {
                this.isUserTouch && ((this.isUserTouch = !1), e || (this.isUserMove ? this.flip.stopMove() : this.flip.flip(t)));
            }
            checkPage(t) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            for (const a of o)
                a.addEventListener("click", (o) => {
                    ...
                    "html" === r.dataset.dest
                        ? ((h = e), (s.style.display = "none"), (i.style.display = "block"), e.getUI().update(), e.update())
                        : ((h = t), (s.style.display = "block"), (i.style.display = "none"), t.getUI().update(), t.update());
                });
            document.querySelector(".btn-book-next").addEventListener("click", () => {
                ...
                t.on("flip", (e) => {
                    ...
                    (document.querySelector(".page-count").innerHTML = i.toString(10)), (document.querySelector(".page-total").innerHTML = t.getPageCount().toString(10));
                }),
                e.on("flip", (t) => {
                    const i = parseInt(t.data.toString(), 10) + 1;
                    (document.querySelector(".page-count").innerHTML = i.toString(10)), (document.querySelector(".page-total").innerHTML = e.getPageCount().toString(10));
                }),
